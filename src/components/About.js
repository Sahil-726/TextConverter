    ...
    return (
     ...
     <div className="accordion" id="accordionExample" >
        ...
        <div className="accordion-item">
            ...
            <div id="collapseTwo" className="accordion-collapse collapse" data-bs-parent="#accordionExample"style={mode}>
            <div className="accordion-body">
        ...
        <div className="accordion-item">
            ...
            <div id="collapseThree" className="accordion-collapse collapse" data-bs-parent="#accordionExample"style={mode}>
            <div className="accordion-body">
        ...
        <div className="container">
            <button className="btn btn-success my-2" onClick={click}>{btnText}</button>
        </div>
        </div>
    );
}
